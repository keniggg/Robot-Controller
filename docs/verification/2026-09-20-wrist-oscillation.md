...
后续2026.9.20已完成另一独立新计划的真实7步补偿：17.874→5.903 mm，原6 mm/5°通过；350帧原始回包J5不变。最终视觉复核仍失败、未闭爪/提起；交接修复与后续验证见[剩余额度搜索记录](2026-09-20-pregrasp-budget-guide.md)。

**本页八步实验结论：保持J2/J5后，实际8步补偿把FK残差18.784804→7.303033 mm（下降61.12%）；381帧/约38 s原始回包中J5始终1034 count，未复现此前振荡。仍超过6 mm，未闭爪或提起，完整抓取尚未成功。** 本页下方保留历次失败及证据边界。
