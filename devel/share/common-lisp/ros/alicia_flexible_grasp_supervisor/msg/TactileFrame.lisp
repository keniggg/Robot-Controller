...
(cl:defmethod skin_id-val ((m <TactileFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader alicia_flexible_grasp_supervisor-msg:skin_id-val is deprecated.  Use alicia_flexible_grasp_supervisor-msg:skin_id instead.")
  (skin_id m))
...
(cl:defmethod total_force-val ((m <TactileFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader alicia_flexible_grasp_supervisor-msg:total_force-val is deprecated.  Use alicia_flexible_grasp_supervisor-msg:total_force instead.")
  (total_force m))

(cl:ensure-generic-function 'max_force-val :lambda-list '(m))
(cl:defmethod max_force-val ((m <TactileFrame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader alicia_flexible_grasp_supervisor-msg:max_force-val is deprecated.  Use alicia_flexible_grasp_supervisor-msg:max_force instead.")
  (max_force m))
...
(cl:defmethod status-val ((m <TactileFrame>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TactileFrame>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'total_force))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TactileFrame>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'values)))
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'total_force) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TactileFrame>)))
  ...
  "02ca98ed2c6b94321c339531010cfc87")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TactileFrame)))
  "Returns md5sum for a message object of type 'TactileFrame"
  "02ca98ed2c6b94321c339531010cfc87")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TactileFrame>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%uint8 skin_id~%uint16 rows~%uint16 cols~%float32[] values~%float32 total_force~%float32 max_force~%uint16 max_index~%float32 center_x~%float32 center_y~%bool contact~%bool valid~%string status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TactileFrame)))
  "Returns full string definition for message of type 'TactileFrame"
  (cl:format cl:nil "std_msgs/Header header~%uint8 skin_id~%uint16 rows~%uint16 cols~%float32[] values~%float32 total_force~%float32 max_force~%uint16 max_index~%float32 center_x~%float32 center_y~%bool contact~%bool valid~%string status~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
