...
echo_and_run cd "/home/zhuyupei/alicia_wa_full/src/real-arm/alicia_duo_calibration/rqt_easy_handeye"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/zhuyupei/alicia_wa_full/src/real-arm/alicia_duo_calibration/rqt_easy_handeye/setup.py" \
    egg_info --egg-base /home/zhuyupei/alicia_wa_full/build/real-arm/alicia_duo_calibration/rqt_easy_handeye \
    build --build-base "/home/zhuyupei/alicia_wa_full/build/real-arm/alicia_duo_calibration/rqt_easy_handeye" \
    install \
    --root="${DESTDIR-/}" \
